...
var UploadService = function () {
    ...
    var UploadService = _classThis = /** @class */ (function () {
        ...
        UploadService_1.prototype.saveImage = function (file, userId, udCode, stepId) {
            return __awaiter(this, void 0, void 0, function () {
                var baseDir, timestamp, filename, filePath, err_1, url;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            baseDir = path.join(process.cwd(), 'uploads', 'activity-images', String(userId), udCode, stepId);
                            return [4 /*yield*/, fs_1.promises.mkdir(baseDir, { recursive: true })];
                        case 1:
                            _a.sent();
                            timestamp = Date.now();
                            filename = "".concat(timestamp, "_cropped_compressed.jpg");
                        ...
                        case 4:
                            err_1 = _a.sent();
                            console.error('Sharp error:', err_1);
                            throw new Error('No se pudo procesar la imagen');
                        case 5:
                            url = "/uploads/activity-images/".concat(userId, "/").concat(udCode, "/").concat(stepId, "/").concat(filename);
                            return [2 /*return*/, url];
                    }
                });
            });
