...
var ResourceService = function () {
    ...
    var ResourceService = _classThis = /** @class */ (function () {
        ...
        ResourceService_1.prototype.countByStatus = function (status) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (status === 'assigned') {
                        return [2 /*return*/, this.resourceRepository.count({
                                where: { status: (0, typeorm_1.In)(['assigned', 'shared', 'occupied']) },
                            })];
                    }
        ...
        ResourceService_1.prototype.getCurrentAssignments = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.resourceRepository
        ...
        ResourceService_1.prototype.assignResource = function (resourceCode, userEmail) {
            return __awaiter(this, void 0, void 0, function () {
                var resource, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            resource = _a.sent();
                            if (!resource) {
                                throw new common_1.NotFoundException("Resource with code ".concat(resourceCode, " not found"));
                            }
        ...
        ResourceService_1.prototype.releaseResource = function (resourceCode) {
            return __awaiter(this, void 0, void 0, function () {
                var resource;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        ResourceService_1.prototype.findAll = function (query) {
            return __awaiter(this, void 0, void 0, function () {
                var status, location, type, userId, _a, page, _b, limit, queryBuilder, skip, _c, data, total;
        ...
        ResourceService_1.prototype.create = function (createResourceDto) {
            return __awaiter(this, void 0, void 0, function () {
                var userId, resourceData, newResource;
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this.resourceRepository.save(newResource)];
                });
            });
        };
        ResourceService_1.prototype.update = function (id, updateResourceDto) {
            return __awaiter(this, void 0, void 0, function () {
                var resource, userId, updateData;
                return __generator(this, function (_a) {
                    switch (_a.label) {
