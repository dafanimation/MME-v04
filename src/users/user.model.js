...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            this.createdAt = (__runInitializers(this, _kingdom_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _group_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _role_decorators = [(0, typeorm_1.Column)({ default: 'user' })];
        _active_decorators = [(0, typeorm_1.Column)({ default: true })];
        _kingdom_decorators = [(0, typeorm_1.Column)({ nullable: true })];
